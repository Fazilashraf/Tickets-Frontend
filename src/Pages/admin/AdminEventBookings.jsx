...
import { getAllEventBookingsAPI } from '../../Services/allAPI';
...
function AdminEventBookings() {
  ...
  const currentBookings = eventBookings.slice(indexOfFirstBooking, indexOfLastBooking);

  const totalPages = Math.ceil(eventBookings.length / bookingsPerPage);
  const pageNumbers = [...Array(totalPages).keys()].map(num => num + 1);

  return (
    <div>
      <h2 className='text-center text-light'>Event Bookings List</h2>
